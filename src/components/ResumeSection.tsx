...
const ResumeSection = () => {
  const handleDownloadResume = () => {
    window.open(
      "https://drive.google.com/file/d/1sPLTFisjfgv7wFJq2tf8KwqAeqTAfBtW/view",
      "_blank",
      "noopener,noreferrer"
    );
  };
      ...
      <div className="max-w-5xl mx-auto text-center">
        ...
        <div className="bg-white text-black p-6 md:p-12 rounded-3xl shadow-xl mb-12">
          ...
          <p className="text-base md:text-lg text-gray-700 mb-8 max-w-2xl mx-auto leading-relaxed px-2">
            View my comprehensive resume to explore my complete background,
            education, detailed project descriptions, and professional
            achievements.
          </p>
